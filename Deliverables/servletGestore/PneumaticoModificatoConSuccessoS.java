...
/**
 * Servlet implementation class PneumaticoModificatoConSuccessoS questa classe
 * si modifica realmente il pneumatico mad un database Pneumatico
 */

@WebServlet("/PneumaticoModificatoConSuccessoS")
public class PneumaticoModificatoConSuccessoS extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PneumaticoModificatoConSuccessoS() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PneumaticoGestore pneumaticoGestore = new PneumaticoGestore(id, nome, larghezza, altezza, diametro,
					stagionalita, marca, "", prezzoF, quantitaI, foto);
			pneumaticoGestore.ModificaPneumatico(dataBase, "Pneumatico.pneumatici");
			output.println("<!DOCTYPE HTML>" + "<html>" + "<head>"
					...
					+ "   <h2 align='center' style='position:relative;top:-40px;'>Pneumatico modificato con successo!</h2>"
