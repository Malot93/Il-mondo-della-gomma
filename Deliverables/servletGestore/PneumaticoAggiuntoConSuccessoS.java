...
/**
 * Servlet implementation class PneumaticoAggiuntoConSuccessoS in questa classe
 * si aggiunge realmente il pneumatico mad un database Pneumatico
 */
@WebServlet("/PneumaticoAggiuntoConSuccessoS")
public class PneumaticoAggiuntoConSuccessoS extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PneumaticoAggiuntoConSuccessoS() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			pneumaticoGestore.inserisciPneumatico(dataBase, "Pneumatico.pneumatici");
			output.println("<!DOCTYPE HTML>" + "<html>" + "<head>"
					...
					+ "   <h2 align='center' style='position:relative;top:-40px;'>Pneumatico aggiunto con successo!</h2>"
					+ "  </div>");
